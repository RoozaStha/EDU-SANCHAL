...
const { newExamination, getAllExaminations, getExaminationsByClass, updateExaminationWithId, deleteExaminationWithId } = require("../controllers/examinations.controller");
...
router.patch("/update/:id", authMiddleware(['SCHOOL']), updateExaminationWithId); // AUTHENTICATED USER FOR UPDATE
