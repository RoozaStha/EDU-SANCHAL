...
import { 
  Box, Button, Stack, Typography, IconButton, Card, CardContent, 
  Chip, Avatar, Divider, Tooltip, Dialog, DialogTitle, DialogContent, 
  DialogActions, Badge, Tabs, Tab, InputAdornment, Paper, Grid, 
  useMediaQuery, LinearProgress, Skeleton, TableContainer, Table, 
  TableHead, TableRow, TableCell, TableBody, TextField, Select, MenuItem,
...
export default function TeacherLeave() {
  ...
  const fetchMyLeaves = async () => {
    try {
      ...
      setMessage("Failed to fetch your leave requests");
      setMessageType("error");
    } finally {
      setLoading(false);
    }
      ...
      >
        <Paper sx={{ 
          ...
          <Box sx={{ 
            ...
            <Chip 
              label={`${myLeaves.length} requests`} 
              color="primary" 
              variant="outlined"
              sx={{ 
                fontWeight: 600,
              ...
              <Table sx={{ minWidth: 650 }} aria-label="leave requests table">
                <TableHead>
                  <TableRow sx={{ backgroundColor: theme.palette.primary.light }}>
                    ...
                    <TableCell sx={{ fontWeight: 700, color: 'white' }}>Approved By</TableCell>
